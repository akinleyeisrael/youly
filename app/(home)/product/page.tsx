...
const ProductPage = () => {
    return (
        <div className='mx-auto items-center max-w-2xl flex flex-col justify-center'>
            ...
            <div className='font-medium text-2xl pt-8 tracking-tighter text-muted-foreground'>
                <div>
